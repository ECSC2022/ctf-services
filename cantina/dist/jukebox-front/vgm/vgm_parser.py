...
class Vgm(KaitaiStruct):
    ...
    class Header(KaitaiStruct):
        ...
        def _read(self):
            ...
            if not self.magic == b"\x56\x67\x6D\x20":
                raise kaitaistruct.ValidationNotEqualError(b"\x56\x67\x6D\x20", self.magic, self._io, u"/types/header/seq/0")
    ...
    class Gd3Tag(KaitaiStruct):
        ...
        def _read(self):
            ...
            if not self.magic == b"\x47\x64\x33\x20":
                raise kaitaistruct.ValidationNotEqualError(b"\x47\x64\x33\x20", self.magic, self._io, u"/types/gd3_tag/seq/0")
    ...
    def data(self):
        ...
        self._m_data = self._io.read_bytes(((self.header.gd3_offset + 20) - (self.header.vgm_data_offset + 52)))
        self._io.seek(_pos)

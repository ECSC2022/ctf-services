...
class VGM:
    ...
    def file_info(self):
        ...
        #print(bytes(self.vgm.gd3.track).decode("ascii"))
        #print(bytes(self.vgm.gd3.author).decode("ascii"))
        #print(bytes(self.vgm.gd3.notes).decode("ascii"))
        ...
        try:
            ...
            while True:
                ...
                if cmd == 0xB4:
                    ...
                    raise ValueError(f"Unknow cmd 0x{cmd:x} at offset {index}")
